...
{
    public class PaymentCardTokenizedItem : EntityBaseCore, IEntityValidateCore
    {
        public virtual PaymentCardTokenized? PaymentCardTokenized { get; set; }
        ...
        public virtual async Task SaveValidate()
        {
            ...
            if (PaymentCardTokenized == null)
                mensagens.Add($"Deve ser informado o PaymentCardTokenized");
