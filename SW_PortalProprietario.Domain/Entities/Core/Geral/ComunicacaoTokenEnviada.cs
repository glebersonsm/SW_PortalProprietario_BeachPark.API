...
{
    /// <summary>
    /// Registro de toda comunicaÃ§Ã£o de token 2FA enviada (e-mail ou SMS).
    ...
    public class ComunicacaoTokenEnviada : EntityBaseCore
    {
        ...
        /// <summary> Login do usuÃ¡rio no momento do envio (para consultas e relatÃ³rios). </summary>
        public virtual string? Login { get; set; }
        /// <summary> Canal: "email" ou "sms". </summary>
        public virtual string? Canal { get; set; }
        /// <summary> DestinatÃ¡rio (e-mail ou nÃºmero de telefone utilizado). </summary>
        ...
        /// <summary> Id da sessÃ£o 2FA no cache (para rastreio). </summary>
