...
{
    public class ContaPagarAlteradorValorViewModel
    {
        /// <summary>
        ...
        public static explicit operator ContaPagarAlteradorValorViewModel(LanctoDocum model)
        {
            return new ContaPagarAlteradorValorViewModel
            {
