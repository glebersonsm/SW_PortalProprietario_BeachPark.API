    ...
    public class HospedeInputModel
    {
        ...
        public static explicit operator HospedeInputDto(HospedeInputModel model)
        {
            return new HospedeInputDto
            {
                ...
                Nome = model.Nome,
                Cpf = model.Cpf,
                DataNascimento = model.DataNascimento.HasValue ? $"{model.DataNascimento:yyyy-MM-dd}" : null,
                ...
                CheckIn = model.DataCheckin.HasValue ? $"{model.DataCheckin:yyyy-MM-dd}" : null,
                CheckOut = model.DataCheckout.HasValue ? $"{model.DataCheckout:yyyy-MM-dd}" : null
            };
        }
