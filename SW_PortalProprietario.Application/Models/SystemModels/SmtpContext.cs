...
namespace SW_PortalProprietario.Application.Models.SystemModels
{
    ...
    {
        /// <summary> ConfiguraÃ§Ãµes SMTP quando disponÃ­veis no sistema; null para usar fallback (.env). </summary>
        ...
        /// <summary> URL base para confirmaÃ§Ã£o de leitura (pixel). Se null/vazio, usa IConfiguration["EmailTrackingBaseUrl"]. </summary>
