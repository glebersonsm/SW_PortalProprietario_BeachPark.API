...
namespace SW_PortalProprietario.Application.Models.SystemModels
{
    public class RegraIntercambioModel : ModelBase
    {
        ...
        /// <summary>IDs dos tipos de semana cedida (eSolution), separados por vÃ­rgula. Vazio = todos.</summary>
        public string TipoSemanaCedida { get; set; } = string.Empty;
        /// <summary>Nomes para exibiÃ§Ã£o (resolvidos a partir dos IDs).</summary>
        public string? TipoSemanaCedidaNome { get; set; }
        /// <summary>IDs dos tipos de semana permitidos para uso (CM), separados por vÃ­rgula. Vazio = todos.</summary>
