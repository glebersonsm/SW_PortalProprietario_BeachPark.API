...
{
    public class TimeSharingDefaultService : ITimeSharingProviderService
    {
        private readonly IRepositoryNHCm _repository;
        private readonly ILogger<TimeSharingDefaultService> _logger;
        public TimeSharingDefaultService(IRepositoryNHCm repository,
            ILogger<TimeSharingDefaultService> logger)
        {
            _logger = logger;
        ...
        public Task<ReservaTimeSharingCMModel> Editar(long reservaId)
        {
            throw new NotImplementedException();
        }
