...
namespace SW_PortalProprietario.Application.Services.Providers.Hybrid
{
    public class FinanceiroHybridService : IFinanceiroHybridProviderService
    {
        ...
        public string PrefixoTransacaoFinanceira_Esol => PREFIXO_TRANSACOES_FINANCEIRAS;
        public string ProviderName_Esol => "EsolutionProvider";

        // CM Properties (from FinanceiroCmService)
        private const string PREFIXO_TRANSACOES_FINANCEIRAS_CM = "PORTALPROPCM_";
        public string PrefixoTransacaoFinanceira_CM => PREFIXO_TRANSACOES_FINANCEIRAS_CM;
        public string ProviderName_CM => "CM"; // Hardcoded or from CommunicationProvider

        public FinanceiroHybridService(ILogger<FinanceiroHybridService> logger,
        ...
        public async Task<PessoaParaTransacaoBrokerModel?> GetDadosPessoa_Esol(int pessoaProviderId)
        {
        ...
        private async Task<List<ContaPendenteModel>> GetContasGeralParaPagamento_Esol(List<int> itensToPay, string empreendimentoId, string pessoaProviderId)
        {
        ...
        public async Task<List<ContaPendenteModel>> GetContasParaPagamentoEmCartaoGeral_Esol(DoTransactionCardInputModel getContasParaPagamentoEmCartaoModel)
        {
            ...
            var itensEncontrados = await GetContasGeralParaPagamento_Esol(getContasParaPagamentoEmCartaoModel.ItensToPay, empreendimentoId, $"{ProviderName_Esol}");
        ...
        public async Task<(int pageNumber, int lastPageNumber, List<ContaPendenteModel> contasPendentes)?> GetContaPendenteDoUsuario_Esol(SearchContasPendentesUsuarioLogado searchModel)
        {
            var parametrosSistema = await _repositorySystem.GetParametroSistemaViewModel();
        ...
        public async Task<(int pageNumber, int lastPageNumber, List<ContaPendenteModel> contasPendentes)?> GetContaPendenteGeral_Esol(SearchContasPendentesGeral searchModel)
        {
            var parametrosSistema = await _repositorySystem.GetParametroSistemaViewModel();
        ...
        public async Task<List<ContaPendenteModel>> GetContasPorIds_Esol(List<int> itensToPay)
        {
            var empreendimentoId = _configuration.GetValue<string>("EmpreendimentoId", "1,21");
            if (string.IsNullOrEmpty(empreendimentoId))
                throw new ArgumentException("Empreendimento não configurado.");
        ...
        public async Task<List<ContaPendenteModel>> GetContasParaPagamentoEmPixGeral_Esol(DoTransactionPixInputModel getContasParaPagamentoEmPixModel)
        {
            ...
            var itensEncontrados = await GetContasGeralParaPagamento_Esol(getContasParaPagamentoEmPixModel.ItensToPay, empreendimentoId, $"{ProviderName_Esol}");
        ...
        public async Task<List<CotaPeriodoModel>> GetProprietariosParaEnvioEmail_Esol(bool pool, bool naoPool)
        {
            var empreendimentoId = _configuration.GetValue<string>("EmpreendimentoId", "1,21");
            if (string.IsNullOrEmpty(empreendimentoId))
                throw new ArgumentException("Empreendimento não configurado.");
        ...
        public async Task<BoletoModel> DownloadBoleto_Esol(DownloadBoleto model)
        {
            ...
            var cliente = await GetDadosPessoa_Esol(contaPendenteVinculadaAoBoleto.PessoaProviderId.GetValueOrDefault());
            if (cliente == null)
        ...
        public async Task<BaixaResultModel> BaixarValoresPagosEmPix_Esol(PaymentPix item, NHibernate.IStatelessSession? session)
        {
        ...
        public async Task<BaixaResultModel> AlterarTipoContaReceberPagasEmCartao_Esol(PaymentCardTokenized item, NHibernate.IStatelessSession? session)
        {
            var usuarioEsolutionUtilizar = _configuration.GetValue<int>("UsuarioEsolutionUtilizar", 1);
        ...
        public async Task<bool> VoltarParaTiposOriginais_Esol(PaymentCardTokenized item, NHibernate.IStatelessSession? session)
        {
            var usuarioEsolutionUtilizar = _configuration.GetValue<int>("UsuarioEsolutionUtilizar", 1);
        ...
        public async Task<int> SalvarContaBancaria_Esol(ClienteContaBancariaInputModel model)
        {
            try
            {
                _repositoryAccessCenter.BeginTransaction();

                ClienteContaBancaria? clienteContaBancaria = await SalvarContaBancariaInterna_Esol(model);
        ...
        public async Task<List<ClienteContaBancariaViewModel>> GetContasBancarias_Esol(int pessoaId)
        {
        ...
        public async Task<ClienteContaBancaria?> SalvarContaBancariaInterna_Esol(ClienteContaBancariaInputModel model, ParametroSistemaViewModel? parametroSistema = null)
        {
            var usuarioEsolutionUtilizar = _configuration.GetValue<int>("UsuarioEsolutionUtilizar", 1);

            var parametrosSistema = parametroSistema ?? await _repositorySystem.GetParametroSistemaViewModel();
            if (parametrosSistema == null)
        ...
        public Task<List<ContaPendenteModel>> GetContasParaPagamentoEmCartaoGeral_CM(DoTransactionCardInputModel getContasParaPagamentoEmCartaoModel)
        {
            throw new NotImplementedException();
        }

        public Task<List<ContaPendenteModel>> GetContasParaPagamentoEmPixGeral_CM(DoTransactionPixInputModel getContasParaPagamentoEmPixModel)
        {
            throw new NotImplementedException();
        }

        public Task<BoletoModel> DownloadBoleto_CM(DownloadBoleto model)
        {
            throw new NotImplementedException();
        }

        public Task<List<ContaPendenteModel>> GetContasParaPagamentoEmCartaoDoUsuario_CM(DoTransactionCardInputModel getContasParaPagamentoEmCartaoModel)
        {
            throw new NotImplementedException();
        }

        public Task<List<ContaPendenteModel>> GetContasParaPagamentoEmPixDoUsuario_CM(DoTransactionPixInputModel getContasParaPagamentoEmPixModel)
        {
            throw new NotImplementedException();
        }

        public Task<PessoaParaTransacaoBrokerModel?> GetDadosPessoa_CM(int pessoaProviderId)
        {
            throw new NotImplementedException();
        }

        public Task<List<ContaPendenteModel>> GetContasPorIds_CM(List<int> itensToPay)
        {
            throw new NotImplementedException();
        }

        public Task<List<CotaPeriodoModel>> GetCotaPeriodo_CM(int pessoaId, DateTime? dataInicial, DateTime? dataFinal)
        {
            throw new NotImplementedException();
        }

        public Task<List<CotaPeriodoModel>> GetProprietariosParaEnvioEmail_CM(bool pool, bool naoPool)
        {
            throw new NotImplementedException();
        }

        public Task<BaixaResultModel> BaixarValoresPagosEmPix_CM(PaymentPix item, NHibernate.IStatelessSession? session)
        {
            throw new NotImplementedException();
        }

        public Task<BaixaResultModel> AlterarTipoContaReceberPagasEmCartao_CM(PaymentCardTokenized item, NHibernate.IStatelessSession? session)
        {
            throw new NotImplementedException();
        }

        public Task<bool> VoltarParaTiposOriginais_CM(PaymentCardTokenized item, NHibernate.IStatelessSession? session)
        {
            throw new NotImplementedException();
        }

        public Task<List<ClienteContaBancariaViewModel>> GetContasBancarias_CM(int pessoaId)
        {
            throw new NotImplementedException();
        }

        public Task<int> SalvarContaBancaria_CM(ClienteContaBancariaInputModel model)
        {
            throw new NotImplementedException();
        }

        public Task<int> SalvarMinhaContaBancaria_CM(ClienteContaBancariaInputModel model)
        {
            throw new NotImplementedException();
        }

        public Task<List<ClienteContaBancariaViewModel>> GetMinhasContasBancarias_CM()
        {
            throw new NotImplementedException();
        }

        public Task<ClienteContaBancaria?> SalvarContaBancariaInterna_CM(ClienteContaBancariaInputModel model, ParametroSistemaViewModel? parametroSistema = null)
        {
            throw new NotImplementedException();
        }
        #endregion
        ...
        public string ProviderName => ProviderName_Esol;
        public string PrefixoTransacaoFinanceira => PrefixoTransacaoFinanceira_Esol;
        ...
        public Task<(int pageNumber, int lastPageNumber, List<ContaPendenteModel> contasPendentes)?> GetContaPendenteGeral(SearchContasPendentesGeral searchModel)
            => GetContaPendenteGeral_Esol(searchModel);
        ...
        public Task<List<ContaPendenteModel>> GetContasParaPagamentoEmCartaoGeral(DoTransactionCardInputModel getContasParaPagamentoEmCartaoModel)
            => GetContasParaPagamentoEmCartaoGeral_Esol(getContasParaPagamentoEmCartaoModel);
        ...
        public Task<List<ContaPendenteModel>> GetContasParaPagamentoEmPixGeral(DoTransactionPixInputModel getContasParaPagamentoEmPixModel)
            => GetContasParaPagamentoEmPixGeral_Esol(getContasParaPagamentoEmPixModel);

        public Task<BoletoModel> DownloadBoleto(DownloadBoleto model)
            => DownloadBoleto_Esol(model);
        ...
        public Task<(int pageNumber, int lastPageNumber, List<ContaPendenteModel> contasPendentes)?> GetContaPendenteDoUsuario(SearchContasPendentesUsuarioLogado searchModel)
            => GetContaPendenteDoUsuario_Esol(searchModel);
        ...
        public Task<List<ContaPendenteModel>> GetContasParaPagamentoEmCartaoDoUsuario(DoTransactionCardInputModel getContasParaPagamentoEmCartaoModel)
            => GetContasParaPagamentoEmCartaoDoUsuario_Esol(getContasParaPagamentoEmCartaoModel);
        ...
        public Task<List<ContaPendenteModel>> GetContasParaPagamentoEmPixDoUsuario(DoTransactionPixInputModel getContasParaPagamentoEmPixModel)
            => GetContasParaPagamentoEmPixDoUsuario_Esol(getContasParaPagamentoEmPixModel);

        public Task<PessoaParaTransacaoBrokerModel?> GetDadosPessoa(int pessoaProviderId)
            => GetDadosPessoa_Esol(pessoaProviderId);

        public Task<List<ContaPendenteModel>> GetContasPorIds(List<int> itensToPay)
            => GetContasPorIds_Esol(itensToPay);

        public Task<List<CotaPeriodoModel>> GetCotaPeriodo(int pessoaId, DateTime? dataInicial, DateTime? dataFinal)
            => GetCotaPeriodo_Esol(pessoaId, dataInicial, dataFinal);

        public Task<List<CotaPeriodoModel>> GetProprietariosParaEnvioEmail(bool pool, bool naoPool)
            => GetProprietariosParaEnvioEmail_Esol(pool, naoPool);

        public Task<BaixaResultModel> BaixarValoresPagosEmPix(PaymentPix item, NHibernate.IStatelessSession? session)
            => BaixarValoresPagosEmPix_Esol(item, session);

        public Task<BaixaResultModel> AlterarTipoContaReceberPagasEmCartao(PaymentCardTokenized item, NHibernate.IStatelessSession? session)
            => AlterarTipoContaReceberPagasEmCartao_Esol(item, session);

        public Task<bool> VoltarParaTiposOriginais(PaymentCardTokenized item, NHibernate.IStatelessSession? session)
            => VoltarParaTiposOriginais_Esol(item, session);

        public Task<List<ClienteContaBancariaViewModel>> GetContasBancarias(int pessoaId)
            => GetContasBancarias_Esol(pessoaId);

        public Task<int> SalvarContaBancaria(ClienteContaBancariaInputModel model)
            => SalvarContaBancaria_Esol(model);

        public Task<int> SalvarMinhaContaBancaria(ClienteContaBancariaInputModel model)
            => SalvarMinhaContaBancaria_Esol(model);

        public Task<List<ClienteContaBancariaViewModel>> GetMinhasContasBancarias()
            => GetMinhasContasBancarias_Esol();
        ...
        public Task<ClienteContaBancaria?> SalvarContaBancariaInterna(ClienteContaBancariaInputModel model, ParametroSistemaViewModel? parametroSistema = null)
            => SalvarContaBancariaInterna_Esol(model, parametroSistema);
        #endregion
