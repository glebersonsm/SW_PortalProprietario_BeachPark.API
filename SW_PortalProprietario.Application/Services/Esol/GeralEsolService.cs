...
namespace SW_PortalProprietario.Application.Services.Esol
{
    ...
    /// </summary>
    public class GeralEsolService : IGeralEsolService
    {
        private readonly IRepositoryNHEsolPortal _repository;
        private readonly ILogger<GeralEsolService> _logger;
        private readonly IConfiguration _configuration;

        public GeralEsolService(IRepositoryNHEsolPortal repository,
            ILogger<GeralEsolService> logger,
