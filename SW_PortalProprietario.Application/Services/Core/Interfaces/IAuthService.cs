...
namespace SW_PortalProprietario.Application.Services.Core.Interfaces
{
    public interface IAuthService
    {
        ...
        /// <summary>
        /// Envia o código 2FA pelo canal escolhido (sem pedir senha).
        ...
        /// <summary>
        /// Lista comunicações de token 2FA enviadas (para auditoria e gerenciamento de volume).
        /// </summary>
        ...
        /// <summary>
        /// Retorna resumo de volume de comunicações de token por canal no período.
        /// </summary>
