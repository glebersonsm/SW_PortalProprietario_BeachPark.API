...
COMMENT ON COLUMN portalohana."ConfigReservaVhf"."TipoHospedeCrianca1" IS 'Tipo de hóspede para Criança1 (6-11 anos). Opcional.';
COMMENT ON COLUMN portalohana."ConfigReservaVhf"."TipoHospedeCrianca2" IS 'Tipo de hóspede para Criança2 (0-5 anos). Opcional.';
