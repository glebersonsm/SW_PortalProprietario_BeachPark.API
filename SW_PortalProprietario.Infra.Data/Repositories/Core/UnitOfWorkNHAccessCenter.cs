...
{
    public class UnitOfWorkNHAccessCenter : IUnitOfWorkNHAccessCenter, IDisposable
    {
        ...
        private readonly ISwAccessCenterSessionFactory? _sessionFactory;

        public UnitOfWorkNHAccessCenter(ISwAccessCenterSessionFactory sessionFactory)
        {
